...
<%--                <button class="btn-lucky" id="l1" type="button" name="button"  value="lucky">--%>
                <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 10px">
                    <button class="btn-lucky" id="l1" type="button" name="button"  value="lucky" style="padding: 10px 20px; background-color: azure; color: #fff; border: none; border-radius: 5px; cursor: pointer;">
                        <img src="css/23901.svg" style="height: 30px; width:30px">
                    </button>
                    <button class="btn-voice" type="button" name="button" id="v1" value="voice" style="padding: 10px 20px; background-color: azure; color: #fff; border: none; border-radius: 5px; cursor: pointer;">
                        <img src="css/microphone-342.svg" style="height: 30px; width:30px">
                    </button>
                </div>
